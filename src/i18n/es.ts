...
export const es: TranslationSchema = {
  nav: {
    ...
    switcher_aria: 'Seleccionar idioma',
    switcher_en: 'EN',
    switcher_es: 'ES',
  ...
  stats: {
    ...
    open_spyglass: 'Abrir Spyglass',
    block_time: 'Tiempo por bloque',
    block_time_metric: 'Segundos',
    transactions: 'Transacciones',
    transactions_metric: 'Total',
    fees_burned: 'Comisiones quemadas',
    fees_metric: 'VFX',
    circulating_supply: 'Suministro circulante',
    supply_metric: 'VFX',
    active_validators: 'Validadores activos',
    start_validating: 'Empezar a validar',
  },

  eco: {
    fw_bitcoin_label: 'Bitcoin',
    fw_bitcoin_sub: 'Depósitos',
    fw_vbtc_label: 'vBTC',
    fw_vbtc_sub: 'Emisión',
    fw_financial_label: 'Actividad',
    fw_financial_sub: 'Financiera',
    fw_liquidity_label: 'Crecimiento',
    fw_liquidity_sub: 'de Liquidez',
    fw_more_apps_label: 'Más',
    fw_more_apps_sub: 'Aplicaciones',
    fw_more_users_label: 'Más',
    fw_more_users_sub: 'Usuarios',
    layer_global_asset: 'Activo Global',
    layer_network: 'Red VerifiedX',
    layer_network_sub: 'El sistema operativo financiero',
    layer_financial: 'Capa financiera',
    layer_applications: 'Aplicaciones',
    bitcoin_sub: 'Capa base · Descentralizado',
    users_label: 'Usuarios y agentes de IA',
    caption_bitcoin: 'es el activo',
    caption_verifiedx: 'es el sistema operativo financiero',
    caption_apps: 'habilitan la actividad financiera',
    aria_flywheel: 'Diagrama del volante financiero de Bitcoin',
  },
