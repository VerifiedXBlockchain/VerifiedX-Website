...
export const externalLinks = {
  ...
  downloadGuiMacArm: 'https://github.com/VerifiedXBlockchain/VerifiedX-GUI/releases/download/5.0.4/VFX-OSX-ARM-Installer.dmg',
  downloadGuiMacIntel: 'https://github.com/VerifiedXBlockchain/VerifiedX-GUI/releases/download/5.0.4/VFX-OSX-Intel-Installer.dmg',
  downloadGuiWindows: 'https://github.com/VerifiedXBlockchain/VerifiedX-GUI/releases/download/5.0.4/VFXWalletSetup-64.exe',
  downloadCli: 'https://github.com/VerifiedXBlockchain/VerifiedX-Core/releases/tag/beta5.0.4',
