...
- [ ] Replace both with **"Current Block Height: **\_**"** in ice blue (live data, similar to NetworkStats)
...
- [ ] Update body copy — add "and is non-synthetic" to end: _"...Each vBTC is backed 1:1 by Bitcoin and is non-synthetic."_
