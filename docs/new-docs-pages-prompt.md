...
These pages are needed to fill remaining placeholder links on the marketing site.

---

## 1. Applications / Wallet Hub Page
...
- CLI download link
- Snapshot link (`https://sync.verifiedx.io`)
- Install & operating instructions link
...
- "Institutional Infrastructure" button (Closing CTA)
- "Institutions" link (Footer > Solutions)

---

## 3. Custody Integration Page
...
**URL:** `/docs/about-vbtc` (sibling of `/docs/introduction`)
...
- vBTC Technical (Core): `https://docs.verifiedx.io/docs/core/vbtc`
- vBTC GUI Docs: `https://docs.verifiedx.io/docs/gui/gui-vbtc`
- vBTC Integration: `https://docs.verifiedx.io/docs/integration/vbtc`
- vBTC Tech & Flow PDF: `https://vfx-resources.s3.us-east-1.amazonaws.com/vBTC-TechAndFlow.pdf`
- Institutional Overview page (page 2 above, once created)
...
- "Mint vBTC" button (vBTC / Unlock section > Retail)
- "How vBTC Works" button (vBTC / Unlock section > Retail)
...
- Page 1 has all existing assets/URLs from the current live site — just needs to be organized into a docs page with Butterfly added
- Page 2 (Institutional Overview) resolves the most placeholder links (5)
- Pages 2, 3, and 4 don't exist yet on the docs site
- All links from the marketing site open in new tabs
